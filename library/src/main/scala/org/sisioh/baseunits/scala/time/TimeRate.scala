...
class TimeRate(
  ...
  /**
    ...
    */
  def over(duration: Duration): BigDecimal =
  ...
  /**
    ...
    */
  def over(duration: Duration,
           scale: Int,
           roundingMode: BigDecimal.RoundingMode.Value): BigDecimal =
...
object TimeRate {
  ...
  /**
    ...
    */
  def apply(quantity: BigDecimal, unit: Duration): TimeRate =
    new TimeRate(quantity, unit)
  ...
  /**
    ...
    * @return [[org.sisioh.baseunits.scala.time.TimeRate]]
    */
  def apply(quantity: String, unit: Duration): TimeRate =
    new TimeRate(quantity, unit)
  ...
  /**
    ...
    */
  def unapply(timeRate: TimeRate): Option[(BigDecimal, Duration)] =
    Some(timeRate.quantity, timeRate.unit)
