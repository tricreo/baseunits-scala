...
/**
  ...
  */
class TimeInterval private[time] (startValue: LimitValue[TimePoint],
  ...
  /**
    ...
    */
  lazy val end: LimitValue[TimePoint] = upperLimit
  ...
  /**
    ...
    * @return 積集合（共通部分）
    */
  def intersect(interval: TimeInterval): TimeInterval =
    super.intersect(interval).asInstanceOf[TimeInterval]
  ...
  /**
    ...
    */
  lazy val start: LimitValue[TimePoint] = lowerLimit
...
object TimeInterval {
  ...
  def closed(start: LimitValue[TimePoint], end: LimitValue[TimePoint]): TimeInterval =
    over(start, startClosed = true, end, endClosed = true)
  ...
  def open(start: LimitValue[TimePoint], end: LimitValue[TimePoint]): TimeInterval =
    over(start, startClosed = false, end, endClosed = false)
  ...
  /**
    ...
    * @throws IllegalArgumentException 下限値が上限値より大きい（未来である）場合
    */
  def over(start: LimitValue[TimePoint],
           startClosed: Boolean,
           end: LimitValue[TimePoint],
  ...
  def over(start: LimitValue[TimePoint], end: LimitValue[TimePoint]): TimeInterval =
    ...
    over(start, startClosed = true, end, endClosed = false)
  ...
  /**
    ...
    * @return 期間
    */
  def preceding(end: Limit[TimePoint],
                startClosed: Boolean,
                length: Duration,
                endClosed: Boolean): TimeInterval = {
  ...
  def preceding(end: Limit[TimePoint], length: Duration): TimeInterval = {
    // Uses the common default for time intervals, [start, end).
    preceding(end, startClosed = true, length, endClosed = false)
  }
  ...
  /**
    ...
    * @return 期間
    */
  def startingFrom(start: Limit[TimePoint],
                   startClosed: Boolean,
                   length: Duration,
                   endClosed: Boolean): TimeInterval = {
  ...
  def startingFrom(start: Limit[TimePoint], length: Duration): TimeInterval =
    startingFrom(start, startClosed = true, length, endClosed = false)
