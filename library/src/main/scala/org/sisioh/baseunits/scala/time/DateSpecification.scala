...
object DateSpecification {
  ...
  /**
    ...
    */
  @deprecated(
    "Use nthOccuranceOfWeekdayInMonth(month: Int, dayOfWeek: DayOfWeek, n: Int, zoneId: ZoneId) method instead",
    "0.1.18")
  def nthOccuranceOfWeekdayInMonth(month: Int,
                                   dayOfWeek: DayOfWeek,
                                   n: Int,
                                   timeZone: TimeZone): DateSpecification =
    new AnnualFloatingDateSpecification(month, dayOfWeek, n, timeZone.toZoneId)

  def nthOccuranceOfWeekdayInMonth(month: Int,
                                   dayOfWeek: DayOfWeek,
                                   n: Int,
                                   zoneId: ZoneId = ZoneIds.Default): DateSpecification =
