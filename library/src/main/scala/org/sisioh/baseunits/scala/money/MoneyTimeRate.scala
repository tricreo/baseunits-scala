...
object MoneyTimeRate {
  ...
  /**
    ...
    */
  def apply(rate: TimeRate, currency: Currency): MoneyTimeRate =
    new MoneyTimeRate(rate, currency)
  ...
  /**
    ...
    * @param duration 時間量
    */
  def apply(money: Money, duration: Duration): MoneyTimeRate =
    new MoneyTimeRate(money, duration)
  ...
  /**
    ...
    */
  def unapply(moneyTimeRate: MoneyTimeRate): Option[(TimeRate, Currency)] =
    Some(moneyTimeRate.rate, moneyTimeRate.currency)
